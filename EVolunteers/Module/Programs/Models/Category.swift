...
struct Category {
    ...
    init(categoryContent: String, colorMask: UIColor) {
...
func CategoryInit() -> [Category] {
    ...
    let category_1 = Category.init(categoryContent: "All", colorMask: colorCollection[0])
    let category_2 = Category.init(categoryContent: "Pendidikan", colorMask: colorCollection[1])
    let category_3 = Category.init(categoryContent: "Kebudayaan", colorMask: colorCollection[2])
    let category_4 = Category.init(categoryContent: "Kesehatan", colorMask: colorCollection[3])
